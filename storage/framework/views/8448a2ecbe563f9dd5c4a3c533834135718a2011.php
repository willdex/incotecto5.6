    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         ...
         <?php echo e(Form::open(array('url' => 'contrasena'))); ?> 
         
              <div class="form-group">

                  <?php echo Form::label('correo','Introduce el correo con el cual ha sido registrado:'); ?>
      ...
      <div class="modal-footer">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <?php echo Form::submit('ENVIAR',['class'=>'btn btn-primary','id'=>'btnPass','name'=>'btnPass']); ?>
