  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper" id="body_principal">
      ...
      <header class="main-header">
        ...
        <span class="logo-lg"> <img src="<?php echo e(asset('images/incotecblack.png')); ?>" class="img-responsive" style="max-width: 81%;"> </span>         
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                 <img src="<?php echo e(asset('images/greenstatus.png')); ?>" class="img-responsive" style="max-width: 15px; margin-right: 5px; margin-top: 5px"  align="left"> <small style="margin-right: 10px">Online</small>
                  <span style="color: #ffff"><b><?php echo e(Auth::user()->correo); ?></b></span>
...
<div>
  <?php echo $__env->make('alerts.cargando', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
       ...
       <script src="/js/laravel.js"></script> 
              <?php echo Html::script('js/crisp.js'); ?>
