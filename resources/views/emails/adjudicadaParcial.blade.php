...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#ececec;">
  ...
  <!--                                                      <tr>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="center" style="padding:0px 40px 0px 40px"><p style="color:#5b5f65; font-size:27px; text-align:center; font-family: Verdana, Geneva, sans-serif"><p style="color:#0074B8; font-size:30px; text-align:center; font-family: Verdana, Geneva, sans-serif"><strong> SISTEMA DE COMPRAS INCOTEC </strong><p style="color:#5b5f65; font-size:24px; text-align:center; font-family: Verdana, Geneva, sans-serif"><strong> ADJUDICACION PROVISIONAL</strong> </p>

                      <p style="color:#5b5f65; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif">Estimado Proveedor, le comunicamos la ADJUDICACION PROVISIONAL de la Solicitud de Propuesta<b style="color: #548DD4;"> "{!!$txttitulo!!}"</b>. La propuesta referida será efectiva una vez que se le haga llegar la Orden de Compra Formal o el Contrato de provisión por parte de Incotec.
                      </p>
